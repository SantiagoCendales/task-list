...
export const TaskItem: React.FC<TaskItemProps> = ({task}) => {
  ...
  return (
    <div key={task.id} className='grid grid-cols-10 gap-4 my-5 bg-neutral-50 shadow-md py-3 rounded-md'>
        ...
        <div className="flex items-center w-full h-full">
          {
            ...
            : (
              <input
                ...
                autoFocus
                type="text" 
                className="border py-1 px-3 rounded-md focus:outline-rose-200"
              />)
          }
        </div>
      ...
      <div className='col-span-2'>
        {
          ...
          ? (
            <div className="flex gap-0 md:gap-5 justify-center">
              <button className="text-neutral-400 p-2 rounded-xl hover:bg-rose-100" onClick={() => setIsEditMode(true)}>
                <LuEdit2 size="22" />
              </button>
              <button className="text-neutral-400 p-2 rounded-xl hover:bg-rose-100" onClick={() => removeTask(task.id)}>
